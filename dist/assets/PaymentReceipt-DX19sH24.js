import{aq as y,r as m,j as a,O as A,aJ as q,aV as g,g as z}from"./index-DBI6pIUh.js";const C=`
...
`;function P(t,l){return`<!DOCTYPE html><html lang="uz" data-theme="light"><head><meta charset="utf-8"><title>${(r=>String(r??"").replace(/[&<>"]/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[s]))(l)}</title><style>${C}</style></head><body>${t}</body></html>`}async function R(t,l){var p,h;if(!t)throw new Error("Chek hali yuklanmadi");const n=l||"Chek",r=P(t.outerHTML,n);if(y()){const c=(h=(p=window.Capacitor)==null?void 0:p.Plugins)==null?void 0:h.ReceiptPrint;if(c){await c.print({html:r,name:n});return}}const s=window.open("","_blank","width=420,height=720");if(!s)throw new Error("Brauzer yangi oynani to'sdi — ruxsat bering va qayta urinib ko'ring");s.document.write(r),s.document.close(),s.onafterprint=()=>s.close(),setTimeout(()=>s.print(),80)}const f=t=>z(t),I={CASH:"Naqd",CARD:"Karta",CLICK:"Click",PAYME:"Payme",TRANSFER:"O'tkazma"},S=t=>new Date(t).toLocaleString("uz-UZ",{dateStyle:"short",timeStyle:"short"});function E({data:t,token:l,appToken:n,customerId:r,id:s,signedId:p,signature:h,onClose:c}){const[e,j]=m.useState(t||null),[x,w]=m.useState(""),[_,b]=m.useState(""),N=m.useRef(null);m.useEffect(()=>{if(t){j(t);return}let i,u={};p?i=`${g}/public/portal/payment/${p}?k=${encodeURIComponent(h)}`:n?(i=`${g}/app/payments/${s}?c=${encodeURIComponent(r)}`,u={"X-App-Token":n}):(i=`${g}/public/portal/payments/${s}`,u={"X-Portal-Token":l}),fetch(i,{headers:u}).then(o=>o.json()).then(o=>{if(o.success===!1)throw new Error(o.message);j(o.data)}).catch(o=>w(o.message||"Chekni ochib bo'lmadi"))},[t,s,l,n,r,p,h]);const v=async()=>{b("");try{await R(N.current,e?`Chek ${e.receiptNo}`:"Chek")}catch(i){b(i.message||"Saqlab bo'lmadi")}},d=(e==null?void 0:e.kind)==="CHARGE",k=e&&!d&&Number(e.balanceAfter)===0;return a.jsx(A,{className:"pt-modal",onClick:c,onEscape:c,role:"dialog","aria-modal":"true",children:a.jsxs("div",{className:"pt-modal__inner",onClick:i=>i.stopPropagation(),children:[a.jsx("button",{className:"pt-close",onClick:c,"aria-label":"Yopish",children:a.jsx("i",{className:"fa-solid fa-xmark","aria-hidden":"true"})}),x&&a.jsx("div",{className:"pt-tape pt-center",children:x}),!e&&!x&&a.jsx("div",{className:"pt-tape pt-center",children:"Yuklanmoqda…"}),e&&a.jsxs("div",{className:"pt-tape ek-tear",ref:N,children:[a.jsxs("div",{className:"pt-tape__head",children:[a.jsx("div",{className:"pt-tape__shop",children:e.shopName}),e.shopAddress&&a.jsx("div",{children:e.shopAddress}),e.shopPhone&&a.jsx("div",{children:e.shopPhone}),a.jsx("div",{className:"pt-tape__kind",children:d?"QARZ OLINDI":"QARZ TO'LOVI"})]}),a.jsx("div",{className:"pt-hr"}),a.jsxs("div",{className:"pt-tape__row",children:[a.jsx("span",{children:"Chek"}),a.jsx("span",{children:e.receiptNo})]}),a.jsxs("div",{className:"pt-tape__row",children:[a.jsx("span",{children:"Sana"}),a.jsx("span",{children:S(e.date)})]}),e.customerName&&a.jsxs("div",{className:"pt-tape__row",children:[a.jsx("span",{children:"Mijoz"}),a.jsx("span",{children:e.customerName})]}),e.cashierName&&a.jsxs("div",{className:"pt-tape__row",children:[a.jsx("span",{children:d?"Berdi":"Qabul qildi"}),a.jsx("span",{children:e.cashierName})]}),a.jsx("div",{className:"pt-hr"}),a.jsxs("div",{className:"pt-tape__row pt-total",children:[a.jsx("span",{children:d?"QARZGA OLINDI":"TO'LANDI"}),a.jsx("span",{children:f(e.amount)})]}),e.method&&!d&&a.jsxs("div",{className:"pt-tape__row",children:[a.jsx("span",{children:"To'lov turi"}),a.jsx("span",{children:I[e.method]||e.method})]}),a.jsx("div",{className:"pt-hr"}),e.balanceBefore!=null&&a.jsxs("div",{className:"pt-tape__row",children:[a.jsx("span",{children:"Qarz edi"}),a.jsx("span",{children:f(e.balanceBefore)})]}),e.balanceAfter!=null&&a.jsxs("div",{className:`pt-tape__row pt-total ${k?"pt-earn":""}`,children:[a.jsx("span",{children:k?"QARZ YOPILDI":d?"JAMI QARZ":"QOLDI"}),a.jsx("span",{children:f(e.balanceAfter)})]}),e.reason&&a.jsxs("div",{className:"pt-tape__row",children:[a.jsx("span",{children:"Izoh"}),a.jsx("span",{children:e.reason})]}),e.qrUrl&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"pt-hr"}),a.jsx("div",{className:"pt-center",dangerouslySetInnerHTML:{__html:q(e.qrUrl,{size:110,margin:1})}}),a.jsx("div",{className:"pt-center pt-tape__no",children:"Chekni telefonda ochish"})]}),a.jsx("div",{className:"pt-hr"}),a.jsx("div",{className:"pt-center pt-tape__no",children:e.receiptNo}),a.jsx("div",{className:"pt-center pt-thanks",children:"Rahmat!"}),a.jsx("div",{className:"pt-center pt-tape__site",children:"e-kassam.uz"})]}),e&&a.jsxs("div",{className:"pt-actions",children:[a.jsxs("button",{type:"button",className:"btn btn-primary",onClick:v,children:[a.jsx("i",{className:"fa-solid fa-file-pdf","aria-hidden":"true"})," PDF qilib saqlash"]}),_&&a.jsx("div",{className:"pt-actions__err",children:_})]})]})})}const O=Object.freeze(Object.defineProperty({__proto__:null,default:E},Symbol.toStringTag,{value:"Module"}));export{E as P,O as a,R as s};
